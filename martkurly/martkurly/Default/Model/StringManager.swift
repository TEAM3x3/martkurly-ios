...
struct StringManager {
    ...
    let category1 = ["3만원 미만", "3~5만원", "5~10만원", "10~20만원", "20만원 이상"]
    let category2 = ["전체보기", "기본채소", "쌈∙샐러드∙간편채소", "브로콜리∙특수채소", "콩나물∙버섯류", "시금치∙부추∙나물", "양파∙마늘∙생강∙파", "파프리카∙피망∙고추"]
    let category3 = ["전체보기", "제철과일", "국산과일", "수입과일", "냉동∙건과일", "견과류", "쌀∙잡곡"]
    let category4 = ["전체보기", "생선류", "오징어∙낙지∙문어", "새우∙게∙랍스터", "해산물∙조개류", "수산가공품", "김∙미역∙해조류", "건어물∙다시팩"]
    let category5 = ["전체보기", "소고기", "돼지고기", "계란류", "닭∙오리고기", "양념육∙돈까스", "양고기"]
    let category6 = ["전체보기", "국∙탕∙찌개", "밑반찬", "김치∙장아찌∙젓갈", "두부∙어물∙부침개", "햄∙소시지∙통조림", "메인요리"]
    let category7 = ["전체보기", "샐러드∙도시락", "간편식∙냉동식품", "밥류∙면식품∙즉석식품", "선식∙시리얼∙그래놀라", "만두∙튀김∙떡볶이", "죽∙스프"]
    let category8 = ["전체보기", "파스타∙면류", "밀가루∙가루∙믹스", "향신료∙소스∙드레싱", "양념∙액젓∙장류", "소금∙설탕∙식초∙꿀", "식용류∙참기름∙오일"]
    let category9 = ["전체보기", "생수∙음료∙주스", "커피∙차", "우유∙두유∙요거트", "아이스크림", "떡∙한과", "간식∙과자∙쿠키", "초콜릿∙젤리∙캔디"]
    let category10 = ["전체보기", "식빵∙빵류", "잼∙버터∙스프레드", "케이크∙파이∙디저트", "치즈", "건조육", "올리브∙피클∙델리"]
    let category11 = ["전체보기", "건강즙∙건강음료", "홍삼∙인삼∙꿀", "영양제", "유산균", "건강분말∙건강환", "유아동"]
    let category12 = ["전체보기", "휴지∙티슈∙위생용품", "세제∙청소용품", "화훼∙인테리어소품", "의약외품∙마스크", "생활잡화∙문구"]
    let category13 = ["전체보기", "스킨케어", "구강∙면도", "바디∙제모", "헤어케어", "미용기기∙소품"]
    let category14 = ["전체보기", "주방소모품", "주방∙조리도구", "냄비∙팬류", "식기류", "컴∙와인잔∙사케잔", "차∙커피도구"]
    let category15 = ["전체보기", "주방가전", "생활가전"]
